...
<?php esc_html_e( 'Skip to content', 'vet-clinic-lite' ); ?>
</a>
<?php
...
<div class="header <?php if( !is_home() && is_front_page() && $header_trans == '') {echo esc_html('transheader');}elseif(!is_home() && !is_front_page() && $header_trans_inner == '') {echo esc_html('transheader');}?>">
	<div class="container">
    <div class="logo">
		<?php vet_clinic_lite_the_custom_logo(); ?>
        <div class="clear"></div>
		<?php	
    ...
    <div id="navigation"><nav id="site-navigation" class="main-navigation">
		...
		<?php wp_nav_menu( array('theme_location' => 'primary', 'container' => 'ul', 'menu_id' => 'primary', 'menu_class' => 'primary-menu menu' ) ); ?>
            ...
            <div class="header-cart">
            	<a class="cart-customlocation" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'vet-clinic-lite' ); ?>"> <img class="cart-customlocation" src="<?php echo esc_url(get_template_directory_uri());?>/images/cart-icon.png" /> <span class="custom-cart-count"><div id="mini-cart-count"></div></span> </a> 
                
                <a class="headcartcount cart-customlocation" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'vet-clinic-lite' ); ?>"><span class="custom-cart-total"><div id="mini-cart-total"></div></span> </a>  
            </div>   
            <?php } ?>
                ...
                <div class="header-phone-number">
                    <?php if (!empty($header_phonenumbertext)) { ?>
                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/header-phone-icon.png">
                        <span><?php esc_html_e('CALL US','vet-clinic-lite');?></span>
